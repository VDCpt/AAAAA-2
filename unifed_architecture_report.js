...
<div class="section">
    ...
    <div class="architecture">
        ...
        ✓ <strong>Processamento Determinístico</strong>: Os mesmos dados de entrada produzem consistentemente os mesmos dados de saída (inexistência de fator aleatório).<br>
...
<div class="section">
    ...
    <div class="compliance">✓ Diretiva UE 2021/514 (DAC7) — Comunicação de Operações de Plataformas Digitais</div>
</div>
